...
import (
	...
	"github.com/cdynot/wether-service/internal/client/http/geocoding"
	"github.com/cdynot/wether-service/internal/client/http/open_meteo"
...
func main() {
	...
	conn, err := pgx.Connect(ctx, "postgresql://cdynot:parol@localhost:54321/weather?sslmode=disable")
	if err != nil {
		panic(err)
	}
